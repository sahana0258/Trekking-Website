function Bandaje(){
    return(
        ...
        <div className="trek-details">
            <img src={Bandaje} alt="" width={100} height={100}></img>
            <h5>Kudremukh Trek</h5>
            <p>Kudremukh is one of the beautiful trekking destinations in Karnataka, surrounded by green mountains and forest</p>
